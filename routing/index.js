...
router.route('/activate_ondc_store/:id').post(adminOndcController.activate_ondc_store);
router.route('/deactivate_ondc_store/:id').post(adminOndcController.deactivate_ondc_store);
